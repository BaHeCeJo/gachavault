          ...
          {addingSkill && (
            <div className="rounded-xl border border-gray-700 bg-gray-900 p-4 space-y-3">
              ...
              <div className="flex gap-2">
                <button onClick={submitSkill} disabled={saving} className="px-4 py-2 bg-white text-black rounded-lg text-sm font-semibold disabled:opacity-50">
                  {saving ? "Saving…" : "Save"}
                </button>
        ...
        <div className="space-y-4">
          ...
          {addingBuild && (
            <div className="rounded-xl border border-gray-700 bg-gray-900 p-4 space-y-3">
              ...
              {saveError && <p className="text-red-400 text-xs">{saveError}</p>}
              <div className="flex gap-2">
                <button onClick={submitBuild} disabled={saving} className="px-4 py-2 bg-white text-black rounded-lg text-sm font-semibold disabled:opacity-50">
                  {saving ? "Saving…" : "Save"}
                </button>
        ...
        <div>
          ...
          {editingLore && (
            <div className="space-y-3">
              ...
              {saveError && <p className="text-red-400 text-xs">{saveError}</p>}
              <div className="flex gap-2">
                <button onClick={saveLore} disabled={saving} className="px-4 py-2 bg-white text-black rounded-lg text-sm font-semibold disabled:opacity-50">
                  {saving ? "Saving…" : "Save"}
                </button>
        ...
        <div className="space-y-3">
          ...
          {addingChangelog && (
            <div className="rounded-xl border border-gray-700 bg-gray-900 p-4 space-y-3">
              ...
              {saveError && <p className="text-red-400 text-xs">{saveError}</p>}
              <div className="flex gap-2">
                <button onClick={submitChangelog} disabled={saving} className="px-4 py-2 bg-white text-black rounded-lg text-sm font-semibold disabled:opacity-50">
                  {saving ? "Saving…" : "Save"}
                </button>
